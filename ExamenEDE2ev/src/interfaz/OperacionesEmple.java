...
public class OperacionesEmple extends JDialog {
	private final class ActionPerformerConsultar implements ActionListener {
	...
	private final class ActionPerformerBorrar implements ActionListener {
	...
	private final class ActionPerformerInsertar implements ActionListener {
	...
	private final class ActionPerformerModificar implements ActionListener {
	...
	public OperacionesEmple() {
		...
		btnInsertar.addActionListener(new ActionPerformerInsertar());
		
		//Accion boton consultar
		btnConsultar.addActionListener(new ActionPerformerConsultar());
		
		//Accion boton borrar
		btnBorrar.addActionListener(new ActionPerformerBorrar());
		
		//Accion boton modificar
		btnModificar.addActionListener(new ActionPerformerModificar());
	}
}
